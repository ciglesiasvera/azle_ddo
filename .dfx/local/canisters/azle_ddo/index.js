...
import { idlFactory } from './azle_ddo.did.js';
export { idlFactory } from './azle_ddo.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.AZLE_DDO_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./azle_ddo.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the azle_ddo canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./azle_ddo.did.js")._SERVICE>}
 */
export const azle_ddo = createActor(canisterId);
